...
#include "Framework/PostProcessManagerLegacy.h"
...
PostProcessManagerLegacy::PostProcessManagerLegacy(int width, int height)
...
PostProcessManagerLegacy::~PostProcessManagerLegacy()
{
}

void PostProcessManagerLegacy::AddProcessor(std::unique_ptr<JPostProcessor> processor) {
    Processors.push_back(std::move(processor));
}

void PostProcessManagerLegacy::ApplyChain(unsigned int inputTexture, int screenWidth, int screenHeight) {
    if (Processors.empty()) {
...
void PostProcessManagerLegacy::Resize(int newWidth, int newHeight) {
    Width = newWidth;
    Height = newHeight;
